    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          ...
          <form enctype="multipart/form-data" method="post" action="{{route('product_update',['id'=>$product->id])}}">
            @csrf
            <div class="row">
              <div class="col-8">
                <div class="form-group">
                  <label for="description">Nhập Nội Dung Bài Giới Thiệu Sản Phẩm</label>
                  <textarea placeholder="Nhập nội dung chi tiết...." name="description" id="description">{{$product->description}}</textarea>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <input value="{{$product->name}}" name="name" type="text" class="form-control" id="name" placeholder="Tên sản phẩm...">
              </div>
              </div>
              <div class="col-4">
               <div class="form-group">
                <label for="quantity_available">Số Lượng</label>
                <input value="{{$product->quantity_available}}" name="quantity_available" type="number" class="form-control" id="quantity_available" placeholder="Số lượng...">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input value="{{$product->price}}" name="price" type="number" class="form-control" id="price" placeholder="Giá...">
              </div>
            </div>
            <div class="col-6">
                  ...
                  <div class="form-group">
                    ...
                    <input value="{{$product->price_discount}}" name="price_discount" type="number" class="form-control" id="price_discount" placeholder="Giá discount...">
                  </div>
                </div>
              </div> 
              ...
              <div class="form-group">
                ...
                <textarea placeholder="Nhập thông số..." name="short_description" id="short_description">{{$product->short_description}}</textarea>
              </div>
            </div>
          </div>
          
          <button style="width: 100%" type="submit" class="btn btn-primary">Sửa Thông Tin Sản Phẩm</button>
        </form>
        </div>
      </div>
      <!-- /.row -->
